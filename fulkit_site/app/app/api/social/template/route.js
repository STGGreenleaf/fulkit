...
function igPostMagic() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 50, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.2 }}>{`It\u2019s not magic.`}</div>
      <div style={{ fontSize: 76, fontWeight: 700, color: TEXT, letterSpacing: -2, lineHeight: 1.2, marginTop: 16 }}>{`It\u2019s memory.`}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostChosen() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", backgroundColor: BG, fontFamily: "D-DIN", position: "relative", padding: "120px 90px" }}>
      <div style={{ fontSize: 48, fontWeight: 700, color: TEXT, letterSpacing: -1, lineHeight: 1.25 }}>{"Everything you see"}</div>
      <div style={{ fontSize: 48, fontWeight: 700, color: TEXT, letterSpacing: -1, lineHeight: 1.25 }}>{"was chosen."}</div>
      <div style={{ width: 60, height: 3, backgroundColor: TEXT, marginTop: 48, marginBottom: 48 }} />
      <div style={{ fontSize: 42, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.25 }}>{`Everything you don\u2019t`}</div>
      <div style={{ fontSize: 42, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.25 }}>{"was removed."}</div>
      <div style={{ position: "absolute", bottom: 70, left: 90, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostWhitespace() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 36, fontWeight: 400, color: SEC, lineHeight: 1.4, textAlign: "center" }}>{`The whitespace isn\u2019t empty.`}</div>
      <div style={{ fontSize: 36, fontWeight: 700, color: TEXT, lineHeight: 1.4, textAlign: "center", marginTop: 8 }}>{`It\u2019s working.`}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostMascot() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", backgroundColor: BG, fontFamily: "D-DIN", position: "relative", padding: "120px 90px" }}>
      <div style={{ fontSize: 40, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.3 }}>{`We don\u2019t have`}</div>
      <div style={{ fontSize: 40, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.3 }}>{"a mascot."}</div>
      <div style={{ width: 60, height: 3, backgroundColor: TEXT, marginTop: 48, marginBottom: 48 }} />
      <div style={{ fontSize: 40, fontWeight: 400, color: SEC, letterSpacing: -1, lineHeight: 1.3 }}>{"We have a"}</div>
      <div style={{ fontSize: 96, fontWeight: 700, color: TEXT, letterSpacing: -3, lineHeight: 1 }}>{"typeface."}</div>
      <div style={{ position: "absolute", bottom: 70, left: 90, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostRams() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 96, fontWeight: 700, color: TEXT, letterSpacing: -3, lineHeight: 1.1, textAlign: "center" }}>{"Less,"}</div>
      <div style={{ fontSize: 96, fontWeight: 700, color: TEXT, letterSpacing: -3, lineHeight: 1.1, textAlign: "center" }}>{"but better."}</div>
      <div style={{ fontSize: 28, fontWeight: 400, color: MUTED, marginTop: 48, letterSpacing: 2 }}>{"\u2014 Dieter Rams, 1960s."}</div>
      <div style={{ fontSize: 28, fontWeight: 400, color: SEC, marginTop: 4, letterSpacing: 2 }}>{"Us, today."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostFewer() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 38, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.2 }}>{`You don\u2019t need`}</div>
      <div style={{ fontSize: 64, fontWeight: 700, color: TEXT, letterSpacing: -2, lineHeight: 1.1, marginTop: 4 }}>{"another app."}</div>
      <div style={{ width: 60, height: 3, backgroundColor: TEXT, marginTop: 40, marginBottom: 40 }} />
      <div style={{ fontSize: 38, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.2 }}>{"You need"}</div>
      <div style={{ fontSize: 64, fontWeight: 700, color: TEXT, letterSpacing: -2, lineHeight: 1.1, marginTop: 4 }}>{"fewer apps."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostStandards() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 40, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.2 }}>{`We didn\u2019t raise`}</div>
      <div style={{ fontSize: 80, fontWeight: 700, color: TEXT, letterSpacing: -3, lineHeight: 1, marginTop: 4 }}>{"money."}</div>
      <div style={{ width: 60, height: 3, backgroundColor: TEXT, marginTop: 44, marginBottom: 44 }} />
      <div style={{ fontSize: 40, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.2 }}>{"We raised"}</div>
      <div style={{ fontSize: 80, fontWeight: 700, color: TEXT, letterSpacing: -3, lineHeight: 1, marginTop: 4 }}>{"standards."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostArgue() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", backgroundColor: BG, fontFamily: "D-DIN", position: "relative", padding: "120px 90px" }}>
      <div style={{ fontSize: 36, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.4 }}>{"Your notes"}</div>
      <div style={{ fontSize: 36, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.4 }}>{"used to just"}</div>
      <div style={{ fontSize: 36, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.4 }}>{"sit there."}</div>
      <div style={{ width: 60, height: 3, backgroundColor: TEXT, marginTop: 44, marginBottom: 44 }} />
      <div style={{ fontSize: 64, fontWeight: 700, color: TEXT, letterSpacing: -2, lineHeight: 1.1 }}>{"Now they"}</div>
      <div style={{ fontSize: 64, fontWeight: 700, color: TEXT, letterSpacing: -2, lineHeight: 1.1 }}>{"argue back."}</div>
      <div style={{ position: "absolute", bottom: 70, left: 90, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostQuiet() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 48, fontWeight: 400, color: DIM, letterSpacing: -1, lineHeight: 1.5, textAlign: "center" }}>{"Pretty is easy."}</div>
      <div style={{ fontSize: 48, fontWeight: 400, color: SEC, letterSpacing: -1, lineHeight: 1.5, textAlign: "center" }}>{"Quiet is hard."}</div>
      <div style={{ fontSize: 48, fontWeight: 700, color: TEXT, letterSpacing: -1, lineHeight: 1.5, textAlign: "center" }}>{"We built quiet."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostInvisible() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 52, fontWeight: 700, color: DIM, letterSpacing: -1, lineHeight: 1.2, textAlign: "center" }}>{"Good design"}</div>
      <div style={{ fontSize: 52, fontWeight: 700, color: DIM, letterSpacing: -1, lineHeight: 1.2, textAlign: "center" }}>{"is invisible."}</div>
      <div style={{ fontSize: 32, fontWeight: 400, color: SEC, marginTop: 40, textAlign: "center" }}>{"You notice the work,"}</div>
      <div style={{ fontSize: 32, fontWeight: 400, color: SEC, textAlign: "center" }}>{"not the interface."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostFriction() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 42, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.2 }}>{`We don\u2019t add features.`}</div>
      <div style={{ width: 60, height: 3, backgroundColor: TEXT, marginTop: 36, marginBottom: 36 }} />
      <div style={{ fontSize: 60, fontWeight: 700, color: TEXT, letterSpacing: -2, lineHeight: 1.15, textAlign: "center" }}>{"We remove"}</div>
      <div style={{ fontSize: 60, fontWeight: 700, color: TEXT, letterSpacing: -2, lineHeight: 1.15, textAlign: "center" }}>{"friction."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostTypeface() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", backgroundColor: BG, fontFamily: "D-DIN", position: "relative", padding: "120px 90px" }}>
      <div style={{ fontSize: 80, fontWeight: 700, color: TEXT, letterSpacing: -3, lineHeight: 1, marginBottom: 16 }}>{"DIN"}</div>
      <div style={{ fontSize: 28, fontWeight: 400, color: MUTED, letterSpacing: 3, marginBottom: 48 }}>{"/ dee-eye-en /"}</div>
      <div style={{ fontSize: 26, fontWeight: 400, color: MUTED, fontStyle: "italic", marginBottom: 32 }}>{"noun."}</div>
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        <div style={{ display: "flex", gap: 12, fontSize: 32, fontWeight: 400, color: SEC, lineHeight: 1.4 }}>
          <span style={{ color: DIM, fontSize: 26, minWidth: 32 }}>{"1."}</span>{"Designed for German road signs."}
        </div>
        <div style={{ display: "flex", gap: 12, fontSize: 32, fontWeight: 400, color: SEC, lineHeight: 1.4 }}>
          <span style={{ color: DIM, fontSize: 26, minWidth: 32 }}>{"2."}</span>{"Legible at 120 km/h. In rain. At night."}
        </div>
        <div style={{ display: "flex", gap: 12, fontSize: 32, fontWeight: 400, color: SEC, lineHeight: 1.4 }}>
          <span style={{ color: DIM, fontSize: 26, minWidth: 32 }}>{"3."}</span><span style={{ display: "flex", alignItems: "center" }}><span>{"See: "}</span>{brandMark(28, false, "muted")}<span>{"."}</span></span>
        </div>
...
function igPostBrains() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG_DARK, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ display: "flex", justifyContent: "center" }}>{brandMark(80, true)}</div>
      <div style={{ fontSize: 80, fontWeight: 700, color: TEXT_INV, letterSpacing: -3, lineHeight: 1.1, marginTop: 8, textAlign: "center" }}>{"your brains out."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostBenefits() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG_DARK, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 44, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.2 }}>{"A friend"}</div>
      <div style={{ fontSize: 64, fontWeight: 700, color: TEXT_INV, letterSpacing: -2, lineHeight: 1.1, marginTop: 4 }}>{"with benefits"}</div>
      <div style={{ width: 60, height: 3, backgroundColor: TEXT_INV, marginTop: 40, marginBottom: 40 }} />
      <div style={{ fontSize: 44, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.2 }}>{"and the benefits"}</div>
      <div style={{ fontSize: 64, fontWeight: 700, color: TEXT_INV, letterSpacing: -2, lineHeight: 1.1, marginTop: 4 }}>{"are real."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostNoise() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG_DARK, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 72, fontWeight: 700, color: TEXT_INV, letterSpacing: -2, lineHeight: 1.2 }}>{"One app."}</div>
      <div style={{ fontSize: 56, fontWeight: 700, color: SEC, letterSpacing: -1, lineHeight: 1.3, marginTop: 8 }}>{"One bestie."}</div>
      <div style={{ fontSize: 36, fontWeight: 400, color: MUTED, lineHeight: 1.3, marginTop: 12 }}>{"Everything else is noise."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostSorry() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG_DARK, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 40, fontWeight: 400, color: SEC, letterSpacing: -1, lineHeight: 1.2 }}>{`Yes, it\u2019s pronounced`}</div>
      <div style={{ fontSize: 64, fontWeight: 700, color: TEXT_INV, letterSpacing: -2, lineHeight: 1.1, marginTop: 4 }}>{"like that."}</div>
      <div style={{ width: 60, height: 3, backgroundColor: TEXT_INV, marginTop: 44, marginBottom: 44 }} />
      <div style={{ fontSize: 40, fontWeight: 400, color: SEC, letterSpacing: -1, lineHeight: 1.2 }}>{`No, we\u2019re not`}</div>
      <div style={{ fontSize: 80, fontWeight: 700, color: TEXT_INV, letterSpacing: -3, lineHeight: 1, marginTop: 4 }}>{"sorry."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostEnergy() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG_DARK, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 88, fontWeight: 700, color: TEXT_INV, letterSpacing: -3, lineHeight: 1 }}>{"Bestie"}</div>
      <div style={{ fontSize: 56, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.2, marginTop: 4 }}>{"energy,"}</div>
      <div style={{ width: 60, height: 3, backgroundColor: TEXT_INV, marginTop: 44, marginBottom: 44 }} />
      <div style={{ fontSize: 44, fontWeight: 400, color: SEC, letterSpacing: -1, lineHeight: 1.2 }}>{"not servant"}</div>
      <div style={{ fontSize: 44, fontWeight: 400, color: SEC, letterSpacing: -1, lineHeight: 1.2 }}>{"energy."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostVaultCard() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", backgroundColor: BG_DARK, fontFamily: "D-DIN", position: "relative", padding: "120px 90px" }}>
      <div style={{ fontSize: 40, fontWeight: 400, color: SEC, letterSpacing: -1, lineHeight: 1.2 }}>{"We built the"}</div>
      <div style={{ fontSize: 96, fontWeight: 700, color: TEXT_INV, letterSpacing: -3, lineHeight: 1, marginTop: 4 }}>{"vault"}</div>
      <div style={{ fontSize: 40, fontWeight: 400, color: SEC, letterSpacing: -1, lineHeight: 1.2, marginTop: 36 }}>{"before we built the"}</div>
      <div style={{ fontSize: 96, fontWeight: 700, color: TEXT_INV, letterSpacing: -3, lineHeight: 1, marginTop: 4 }}>{"product."}</div>
      <div style={{ position: "absolute", bottom: 70, left: 90, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostFul() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG_DARK, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 64, fontWeight: 700, color: TEXT_INV, letterSpacing: -2, lineHeight: 1.15 }}>{`Go F\u00FCl yourself.`}</div>
      <div style={{ fontSize: 44, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.3, marginTop: 24 }}>{"Seriously."}</div>
      <div style={{ fontSize: 44, fontWeight: 400, color: SEC, letterSpacing: -1, lineHeight: 1.3, marginTop: 8 }}>{"You deserve it."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
...
function igPostRemember() {
  return (
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", backgroundColor: BG_DARK, fontFamily: "D-DIN", position: "relative" }}>
      <div style={{ fontSize: 76, fontWeight: 700, color: TEXT_INV, letterSpacing: -2, lineHeight: 1.15, textAlign: "center" }}>{"Remember"}</div>
      <div style={{ fontSize: 76, fontWeight: 700, color: TEXT_INV, letterSpacing: -2, lineHeight: 1.15, textAlign: "center" }}>{"everything."}</div>
      <div style={{ width: 60, height: 3, backgroundColor: TEXT_INV, marginTop: 40, marginBottom: 40 }} />
      <div style={{ fontSize: 52, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.2, textAlign: "center" }}>{"Explain"}</div>
      <div style={{ fontSize: 52, fontWeight: 400, color: MUTED, letterSpacing: -1, lineHeight: 1.2, textAlign: "center" }}>{"nothing."}</div>
      <div style={{ position: "absolute", bottom: 70, fontSize: 28, fontWeight: 700, color: MUTED, letterSpacing: 6 }}>{"FULKIT.APP"}</div>
    </div>
  );
}
