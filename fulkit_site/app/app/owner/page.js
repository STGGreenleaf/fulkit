...
const PITCHES = [
  ...
  { cat: "Brand", text: "Form follows function. Color follows meaning. Everything else is removed." },
  { cat: "Brand", text: "One color family. Warm grey. Because your work is the color." },
  { cat: "Brand", text: "The font was designed for German road signs. Legible at 120 km/h, in rain, at night. We use it because every word should earn its place." },
  { cat: "Brand", text: "Dieter Rams said \u2018less, but better.\u2019 We took it literally." },
  { cat: "Brand", text: "When in doubt: what would Rams do? Remove something.", star: true },
  { cat: "Brand", text: "No gradients pretending to be depth. No shadows pretending to be dimension." },
  ...
  { cat: "Brand", text: "We don\u2019t have a mascot. We have a typeface.", star: true },
  { cat: "Brand", text: "Everything you see traces back to a century of German and Swiss design thinking. This isn\u2019t trend-chasing. It\u2019s a philosophy." },
  { cat: "Brand", text: "Eggshell, not white. Deep slate, not black. Warm, not cold. Every choice is intentional." },
  { cat: "Brand", text: "The whitespace is working. The horizontal rules are architecture." },
  // ── Social Posts ──
