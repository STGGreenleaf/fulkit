...
const OWNER_NOTES = [
  ...
  {
    category: "User Integrations (23 live)",
    items: [
      { name: "Google Suite", url: "https://console.cloud.google.com", note: "\u2705 Calendar (4 tools) + Gmail (2 tools) + Drive (3 tools). Verification submitted." },
      { name: "GitHub", url: "https://github.com/settings/developers", note: "\u2705 6 chat tools + 3 Vercel tools. Dev loop: multi-write, test runner." },
      { name: "Spotify", url: "https://developer.spotify.com", note: "\u2705 5-seat extended quota. Fabric player + audio viz." },
      { name: "Sonos", url: "https://developer.sonos.com", note: "\u2705 OAuth + speaker picker + per-speaker volume. B-Side speaker control." },
      { name: "Square", url: "https://developer.squareup.com", note: "\u2705 17 chat tools. Daily summary, orders, inventory, customers." },
      { name: "Shopify", url: "https://partners.shopify.com", note: "\u2705 6 chat tools. Products, orders, customers." },
      { name: "Stripe", url: "https://dashboard.stripe.com", note: "\u2705 13 chat tools. Revenue, subscriptions, invoices." },
      { name: "Toast", url: "https://developer.toasttab.com", note: "\u2705 6 chat tools. Restaurant orders, menu, labor." },
      { name: "Trello", url: "https://trello.com/power-ups/admin", note: "\u2705 Boards, cards, due dates." },
      { name: "Numbrly", url: "https://numbrly.app", note: "\u2705 10 chat tools. Margins, vendors, components, simulations." },
      { name: "TrueGauge", url: "https://truegauge.app", note: "\u2705 15 chat tools. Pace, cash, expenses, health score." },
      { name: "Fitbit", url: "https://dev.fitbit.com", note: "\u2705 Daily summary, sleep, heart rate, weight." },
      { name: "Strava", url: "https://developers.strava.com", note: "\u2705 Activities, stats, splits. 1000-athlete review submitted." },
      { name: "QuickBooks", url: "https://developer.intuit.com/app/developer/dashboard", note: "\u2705 P&L, balance sheet, invoices, expenses, customers." },
      { name: "Notion", url: "https://www.notion.so/my-integrations", note: "\u2705 Search pages, read content, import to vault." },
      { name: "Dropbox", url: "https://www.dropbox.com/developers/apps", note: "\u2705 File search + read." },
      { name: "Slack", url: "https://api.slack.com/apps", note: "\u2705 Search messages, channels, history." },
      { name: "OneNote", url: "https://portal.azure.com", note: "\u2705 Notebooks, sections, page content." },
      { name: "Todoist", url: "https://developer.todoist.com/appconsole.html", note: "\u2705 Tasks, projects, priorities." },
      { name: "Readwise", url: "https://readwise.io/access_token", note: "\u2705 API key based. Highlights, books." },
      { name: "Asana", url: "https://app.asana.com/0/developer-console", note: "\u2705 3 chat tools. Tasks, projects, create. Session 29." },
      { name: "Monday.com", url: "https://monday.com/developers/apps", note: "\u2705 3 chat tools. Boards, items, create. Session 29." },
      { name: "Linear", url: "https://linear.app/settings/api", note: "\u2705 3 chat tools. Issues, teams, create. GraphQL. Session 30." },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Whoop", url: "https://developer-dashboard.whoop.com", note: "\u23F3 Requires device + membership. Vital Day." },
      { name: "Oura", url: "https://cloud.ouraring.com/oauth/applications", note: "\u23F3 Requires ring + account. Vital Day." },
      { name: "Garmin", url: "https://developerprogram.garmin.com", note: "\u23F3 OAuth 1.0a. Vital Day." },
      { name: "SoundCloud", url: "https://developers.soundcloud.com", note: "\u23F3 Pending Artist Pro + API approval." },
      { name: "Apple Music", url: "https://developer.apple.com/musickit", note: "\u23F3 $99/yr Apple Developer. Third Fabric source." },
      { name: "HIBP", url: "https://haveibeenpwned.com/API/Key", note: "\u23F3 Breach check. $3.50/mo. Code ready, needs key." },
      { name: "Terra/Vital", url: "https://dashboard.tryvital.io", note: "\u274C $300-499/mo. Revisit at scale." },
    ],
  },
  {
...
const PITCHES = [
  ...
  { cat: "Features", text: "No habit app. No checkboxes. No guilt. Just say what you do and F\u00FClkit handles the rest.", star: true },
  { cat: "Features", text: "Strava logged a run? Habit checked. Fitbit tracked your sleep? Streak updated. You didn\u2019t do anything.", star: true },
  ...
  { cat: "Features", text: "Start on your phone. Your notes follow you home. Desktop vault syncs everything as .md files.", star: true },
...
function PlaygroundTab() {
  ...
  // ── Email HTML builder (shared source of truth: lib/email-templates.js) ──
  const emailHtml = buildEmailHtml(emailTemplate);
