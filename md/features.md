# Fülkit — Features & Value Proposition
...
**Fülkit is the last app you'll ever need.**

One bestie. One interface. Everything else is noise.
...
### 2. The Hum — Talk to a Presence

**What it is:** A floating, animated orb you talk to. No transcript on screen. Full two-way conversation.

**What makes it different:**
- GPT's voice mode shows your words being typed. That activates your inner editor. You get self-conscious.
- The Hum just listens. It breathes, pulses, reacts. You talk to a vibe, not a transcript.
- After you're done, Fülkit silently: transcribes everything, extracts action items, identifies topics, files notes.
...
**How it works:**
- Default: 2 whispers per day
- Adjustable through conversation: "check in more" / "dial it back"
- Topic scoping through text: "only food stuff during the day"
- If you don't respond, the whisper fades. No guilt. No badge. No "you missed this!"

**Example whispers:**
- "You mentioned wanting to rework the pricing page. Your notes on loss aversion might help."
...
**The promise:** Fülkit buries this not because it's hiding anything — because most users don't need it. For those who do, it's all there.
...
## Changelog
- v1.0 — Initial features doc. App replacement table, cost comparison, 10 core features, competitive grid, stats, infographic layout, copy bank.
